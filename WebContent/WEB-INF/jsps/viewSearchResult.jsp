...
<body>
    ...
    <div class="container">
        <h3 style="text-align: center; padding-top: 80px; padding-bottom: 50px" class="text-dark font-weight-bold">Kết
            quả tìm kiếm cho: ${searchValue }</h3>
        <div class="row">
                        ...
                        <c:forEach var="pageNum" begin="0" end="${noPage - 1 }" step="1">
                            <c:choose>
                                <c:when test="${page == pageNum }">
                                    <li class="page-item active"><a class="page-link" href="${pageContext.request.contextPath }/viewSearchResult?search=${searchValue}&&page=${pageNum}">${pageNum
                                            + 1}</a></li>
                                </c:when>
                                <c:otherwise>
                                    <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath }/viewSearchResult?searchValue=${searchValue}&&page=${pageNum}">${pageNum
                                            + 1}</a></li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
